...
\begin{figure}[h]
  \begin{center}
      ...
      \subfloat[1]{\includegraphics[width=60mm]{sb19a1.png}} \quad
      \subfloat[2]{\includegraphics[width=60mm]{sb19a2.png}}\\
      \subfloat[3]{\includegraphics[width=60mm]{sb19a3.png}} \quad
      \subfloat[4]{\includegraphics[width=60mm]{sb19a4.png}} 
...
\newcommand{\FIGbifurcationdiagramD}{
\begin{figure}[h]
  \begin{center}
    \mbox{
      \subfloat[$P20$ branch with first secondary branch]{\includegraphics[width=60mm]{BifurcationDiagram_q12pb20.png}} \quad
      \subfloat[$P24$ branch with first secondary branch]{\includegraphics[width=60mm]{BifurcationDiagram_q12pb24.png}} 
      }
    \caption{Bifurcation diagrams showing competing periodic solutions and secondary snaking branches for each.}
    \label{fig:bifurcationdiagramq12}
  \end{center}
\end{figure}
}

\newcommand{\FIGsnakingC}{
\begin{figure}[h]
  \begin{center}
    
      \subfloat[1]{\includegraphics[width=40mm]{q12sb20aL_sol1.png}} \quad
      \subfloat[2]{\includegraphics[width=40mm]{q12sb20aL_sol2.png}}\quad
      \subfloat[3]{\includegraphics[width=40mm]{q12sb20aL_sol3.png}}
    
      
    \caption{Localized solutions along snaking branch that bifurcates from $P20$ and terminates on the left side of Fig.~\ref{fig:bifurcationdiagramq12}.}
    \label{fig:snakingq12p20aL}
  \end{center}
\end{figure}
}

\newcommand{\FIGsnakingD}{
\begin{figure}[h]
  \begin{center}
    
      \subfloat[1]{\includegraphics[width=40mm]{q12sb20aR_sol1.png}} \quad
      \subfloat[2]{\includegraphics[width=40mm]{q12sb20aR_sol2.png}}\quad
      \subfloat[3]{\includegraphics[width=40mm]{q12sb20aR_sol3.png}}\\
      \subfloat[4]{\includegraphics[width=40mm]{q12sb20aR_sol4.png}} \quad
      \subfloat[5]{\includegraphics[width=40mm]{q12sb20aR_sol5.png}}\quad
      \subfloat[6]{\includegraphics[width=40mm]{q12sb20aR_sol6.png}}
      
    \caption{Localized solutions along snaking branch that bifurcates from $P20$ and terminates on the right side of Fig.~\ref{fig:bifurcationdiagramq12}.}
    \label{fig:snakingq12p20aR}
  \end{center}
\end{figure}
}

\newcommand{\FIGsnakingE}{
\begin{figure}[h]
  \begin{center}
    
      \subfloat[1]{\includegraphics[width=60mm]{q12sb24a_sol1.png}} \quad
      \subfloat[2]{\includegraphics[width=60mm]{q12sb24a_sol2.png}}\\
      \subfloat[3]{\includegraphics[width=60mm]{q12sb24a_sol3.png}}\quad
      \subfloat[4]{\includegraphics[width=60mm]{q12sb24a_sol4.png}} 
      
    \caption{Localized solutions along snaking branch that bifurcates from $P24$.}
    \label{fig:snakingq12p24a}
  \end{center}
\end{figure}
}
