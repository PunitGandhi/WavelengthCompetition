...
\begin{align}
\dot{A}=\mu A+4\left(q^2-1\right)^2  A''-\left(3-\frac{4 b^2}{q^4}-\frac{2 b^2}{9(q^2-4)^2}\right)|A|^2A-\left(6-\frac{4 b^2}{q^4} \right)|B|^2 A\\
\dot{B}=\left(\mu-\delta (q^2-1)^2\right) B+4q^2\left(q^2-1\right)^2  B''-\left(3-\frac{4 b^2}{q^4}-\frac{2 b^2}{9q^2(1-4q^2)^2}\right)|B|^2B-\left(6-\frac{4 b^2}{q^4} \right)|A|^2 B
\end{align}
